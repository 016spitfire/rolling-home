...
export function GameTemplateRunner({ template, settings, toolStates, onExit }) {
        ...
        <div className="setup-screen">
          ...
          {template.setupVariables.length === 0 ? (
            <p className="setup-hint">
              No setup required. Press Start to begin!
            </p>
          ) : (
                ...
                {stepResult.type === "dice" && (
                  <div className="result-dice">
                    ...
                    <p className="dice-grand-total">
                      Total:{" "}
                      {stepResult.results.reduce((sum, r) => sum + r.total, 0)}
                    </p>
                  </div>
                )}
              </div>
